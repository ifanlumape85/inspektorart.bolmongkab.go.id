...
<head>
    ...
    <title>Inspektorat Bolmong | Registration</title>
    ...
    <div class="register-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="/" class="h3"><b>Inspektorat</b> Bolmong</a>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3">
                        <input id="name" type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="NIK" value="{{ old('nik') }}" required autocomplete="nik" autofocus>
                    ...
                    <div class="input-group mb-3">
                        <input id="telpon" type="text" class="form-control @error('telpon') is-invalid @enderror" name="telpon" placeholder="No. Telp/Ponsel" value="{{ old('telpon') }}" required autocomplete="telpon" autofocus>
